  ...
  module.exports = grammar({
    ...
    rules: {
      ...
      _expression: $ => choice(
        ...
        // $.constant_multiplication_expression
      ),

      // suited_cm_expression: $ => prec.left(PREC.MULTIPLY, choice(
      //   $.subscript_expression,
      //   $.call_expression,
      //   $.field_expression,
      //   $.identifier,
      ...
      // constant_multiplication_expression : $ => prec.right(PREC.SUBSCRIPT, seq(
      //   field('left', $.number_literal),
      //   field('right', choice( $.identifier, $.subscript_expression) )
      // )),
