...
module.exports = grammar(C, {
  ...
  rules: {
    ...
    repeat_statement: $ => seq(  
      ...
      '(',
      field('P1', $._expression),
      optional( choice(
          seq(
              ',', 
              field('P2', $._expression),
          ),
          seq(
              ',', 
              field('P2', $._expression),
              ',', 
              field('P3', $._expression)
          ),
          seq(
              ',', 
              field('P2', $._expression),
   ...
   search_statement: $ => seq(
    ...
    field('name', $.identifier),
    ',',
    field('minvalue', $._expression),
    ',',
    field('maxvalue', $._expression),
    optional(
      seq(
        ',', 
    ...
    return_statement: ($, original) => seq(
      choice(
        original,
        seq('return', choice($._expression, $.comma_expression), $.if_expression, ';'), 
    ...
    if_expression: $ => prec(PREC.CALL, seq(
      "if",
      field('arguments', $.if_argument_list)
    )),

    if_argument_list : $ =>  seq('[', commaSep($._expression), ']'),
    ...
    _pointers: $ => prec.dynamic(1, prec.right(seq(
      '*',
      field('declarator', optional($._pointers))
    ))),
